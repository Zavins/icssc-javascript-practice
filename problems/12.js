...
function problem(fruit) {
    switch(fruit){
        case "orange": return "$1"; break;
        case "apple": return "$1.29"; break;
        case "grapes": return "$1.50"; break;
        case "banana": return "$0.75"; break;
        case "grapefruit": return "$2"; break;
        case "melon": return "$2"; break;
    }
}
